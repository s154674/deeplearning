...
if __name__ == '__main__' and argv[1].lower() in ['ppo', 'impala']:
  ...
  if int(argv[2]) == 1:
    ...
    non_stabelized(encoder, f"{argv[1].lower()}_no_re_{make_env_kwargs['num_levels']}")
    encoder = get_encoder()
    ...
    print(f'stabilized {argv[1].lower()}')
    encoder = get_encoder()
    make_env_kwargs['num_levels']=75
    stabelized(encoder, f"{argv[1].lower()}_no_re_{make_env_kwargs['num_levels']}")
    encoder = get_encoder()
    make_env_kwargs['num_levels']=200
    stabelized(encoder, f"{argv[1].lower()}_no_re_{make_env_kwargs['num_levels']}")
    encoder = get_encoder()
