...
eval_env = make_env(**make_env_kwargs, start_level=300, use_backgrounds=False)
obs = eval_env.reset()
...
state_dict = torch.load("checkpoints\\ppo_1checkpoint2021-12-06 00_48_59.pt", map_location=torch.device('cpu'))
